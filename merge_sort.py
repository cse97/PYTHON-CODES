...
print("Merge sorted list is",list1) 


# The first part repeatedly splits the input list into smaller 
# lists to eventually produce single-element lists. 
# The best, worst and average runtime for first part is Θ(log N). 
# The second part repeatedly merges and sorts the single-element 
# lists to twice its size until the original input size is achieved. 
# The best, worst and average runtime for second part is Θ(N). 
# Therefore, the combined runtime is Θ(N log N).